  ...
  return (
    <main className="mx-auto max-w-[1280px] px-4 py-6">
      ...
      <form action="/tim-kiem" className="mt-3 flex gap-2">
        <input name="q" aria-label="Từ khóa tìm sản phẩm" defaultValue={q} placeholder="Nhập từ khóa..." className="min-h-11 min-w-0 flex-1 rounded-full border bg-white px-4 py-2.5 text-base outline-none focus:ring-2 focus:ring-[var(--michio-deep-rose)]/20" />
